...
C            KGDS(9)  - DI LATITUDINAL DIRECTION INCREMENT
C            KGDS(10) - REGULAR LAT/LON GRID
C                           DJ - LONGITUDINAL DIRECTION
C                                INCREMENT
C                       GAUSSIAN GRID
...
C                       ----- U.S GRID 90     - MAP SIZE 12902
                  J     = 12902
                  GO TO 800
              ELSE IF (KPDS(3).EQ.91) THEN
C                       ----- U.S GRID 91     - MAP SIZE 25803
                  J     = 25803
                  GO TO 800
...
C                       ----- U.S GRID 93     - MAP SIZE 48323
                  J     = 48323
                  GO TO 800
              ELSE IF (KPDS(3).EQ.94) THEN
C                       ----- U.S GRID 94     - MAP SIZE 48916
                  J     = 48916
                  GO TO 800
              ELSE IF (KPDS(3).EQ.95) THEN
C                       ----- U.S GRID 95     - MAP SIZE 97831
                  J     = 97831
                  GO TO 800
              ELSE IF (KPDS(3).EQ.96) THEN
C                       ----- U.S GRID 96     - MAP SIZE 41630
                  J     = 41630
                  GO TO 800
              ELSE IF (KPDS(3).EQ.97) THEN
C                       ----- U.S GRID 97     - MAP SIZE 83259
                  J     = 83259
                  GO TO 800
              ELSE IF (KPDS(3).EQ.98) THEN
